...
**Turn your digital life into a personalized soundtrack.**
...
- 👁️ **AI Vision Analysis** - Analyzes mood, activity, and context using Claude/GPT-4 Vision
- ✍️ **Dynamic Lyric Generation** - Creates contextual lyrics that match your screen activity
- 🎵 **Genre-Based Music** - Adapts music style to your current activity
- 🎬 **Video Generation** - Creates shareable lyric videos with visualizations
- 📊 **Beautiful UI** - Maps.me inspired glassmorphic design with gradient orbs
- 🎨 **Mobile-First** - Optimized for all screen sizes with smooth animations
...
└────────┬────────┘
         ...
         ▼
┌─────────────────┐
│  Vision LLM     │ ◄─── Claude Vision / GPT-4o
│  (Analysis)     │
└────────┬────────┘
         │ Context
         ▼
┌─────────────────┐
│ Lyric Generator │ ◄─── Claude Sonnet
│   (LLM)         │
└────────┬────────┘
         │ Lyrics
         ▼
